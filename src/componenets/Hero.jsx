    ...
    >
      <div className="flex md:flex-row absolute left-0 flex-col px-14 items-center justify-center mb-30 h-52 md:min-w-[60%] text-white">
        <div className=" h-50 mb-10 md:mb-0  md:w-[60%] w-full ">
          ...
          <h2 className=" typewriter text-2xl md:text-4xl font-semibold mb-6">Full Stack Developer | Problem Solver</h2>
          ...
          <div className="flex gap-5">
            <a className="pointer-events-auto px-5 py-2 rounded-md bg-blue-500 hover:bg-blue-700 transition font-semibold" href="">Resume</a>
            <a  className="pointer-events-auto px-5 py-2 rounded-md border-2 font-semibold hover:bg-white/20 transition" href="#contact">Contact Me</a>
          </div>
        </div>
        <div className="flex mt-10 justify-center items-center md:min-w-[40%]">
